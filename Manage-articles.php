...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/e8yip1mitm12dsoy9yfpaqku8cs7k38x7fxu7yjncd82xrc7/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
            ...
            <div class="left">
                ...
                <nav class="nav-header-left">
                    ...
                    <details class="Categories">
                        ...
                        <ul class="Subcategories-list">
                            <li class="Subcategories-item">
                                <a href="#" title="" class="Subcategories-link" > Cập nhật giới thiệu</a>
                            </li>
                            <li class="Subcategories-item">
                                <a href="#" title="" class="Subcategories-link" > Cập nhật liên hệ</a>
                            </li>
                            <li class="Subcategories-item">
                                <a href="#" title="" class="Subcategories-link" > Cập nhật footer</a>
                            </li>
                        </ul>
                    </details> 
                    <details class="Categories">
            ...
            <header class="header-right">
             ...
             <!--   <article class="article">
                ...
                <article class="pro-admin">
                    ...
                    <textarea rows="6" cols="20" class="width-wysiwyg">
